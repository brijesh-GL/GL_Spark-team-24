...
import { itemPresentInWishlist,addToWishList,removeFromWishList } from "../../actions/WishList";
...
const ProductCard=async(props)=> {
  const dispatch=useDispatch()
   await dispatch(itemPresentInWishlist(props.id))
  
   const {flag} = useSelector((state) => state.wishlist.Wish_Data)
